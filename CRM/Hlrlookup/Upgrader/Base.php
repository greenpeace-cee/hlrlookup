 ...
 */
class CRM_Hlrlookup_Upgrader_Base {

  /**
   * @var CRM_Hlrlookup_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Hlrlookup_Upgrader(
        'hlrlookup',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Hlrlookup_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Hlrlookup_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
